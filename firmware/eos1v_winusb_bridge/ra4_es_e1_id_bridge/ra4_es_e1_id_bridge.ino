...
// Experimental UNO R4 Minima USB-identity build. Camera-side behavior and O1
// framing remain identical to ra4_camera_bridge. The companion build script
// changes the descriptors only while compiling. This remains CDC ACM and does
// not emulate the original ES-E1 KLSI/MCCI USB transport.
