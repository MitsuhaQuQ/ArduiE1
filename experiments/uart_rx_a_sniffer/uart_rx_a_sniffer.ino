...
// Passive hardware-UART recorder for the ES-E1 -> EOS-1V direction.
// Connect the protected FOCUS / DATA-A node to D0 (Serial1 RX).
...
static void beginCapture() {
  static const uint8_t magic[8] = {'E', 'O', 'S', '1', 'R', 'X', 'A', '1'};
